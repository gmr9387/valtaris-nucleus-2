...
import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-EW5XaRGG.js";
import { a as requireSupabaseAuth, i as rotateCredentialSchema, n as createCredentialSchema, r as deactivateCredentialSchema } from "./schemas-BohSmhqW.js";
import { a as Th, i as Td, n as FieldStyles, t as Field } from "./_app.organizations-C167SJ8c.js";
import { c as useCredentialProviders, d as useEnvironments, f as useMyOrgMembership, h as useProjects, l as useCredentialVersions, r as canManageSecrets, u as useCredentials } from "./queries-CytnrJBF.js";
import { t as useOrgStore } from "./org-store-DHMPJw-C.js";
import { i as PageHeader, n as MetricCard, r as PageBody, s as StatusPill, t as EmptyState } from "./platform-ui-8S9LjWBS.js";
...
import { KeyRound, LockKeyhole, Plus, RefreshCcw, Search, ShieldOff } from "lucide-react";
...
//#endregion
//#region src/lib/secrets.functions.ts
...
//#endregion
//#region src/routes/_app.secrets.tsx?tsr-split=component
function SecretsPage() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(PageHeader, {
		...
		actions: /* @__PURE__ */ jsxs("button", {
			...
			children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5" }), "New secret"]
		})
	}), /* @__PURE__ */ jsxs(PageBody, { children: [
		!currentOrgId ? /* @__PURE__ */ jsx(EmptyState, {
			title: "Select an organization",
			description: "Secrets are scoped to an organization and isolated by RLS.",
			icon: /* @__PURE__ */ jsx(LockKeyhole, { className: "h-5 w-5" })
		}) : /* @__PURE__ */ jsxs("div", {
			className: "space-y-6",
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("thead", {
							...
							children: /* @__PURE__ */ jsxs("tr", { children: [
								...
								/* @__PURE__ */ jsx(Th, { children: "Last rotated" }),
								...
								return /* @__PURE__ */ jsxs("tr", {
									...
									children: [
										...
										/* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsxs("div", {
											...
											}), env && /* @__PURE__ */ jsx("span", {
												className: "rounded border border-border bg-surface-2 px-1.5 py-0.5",
												children: env.env_type
											})]
										}) }),
										/* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(StatusPill, { status: credential.status }) }),
										/* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx("span", {
		...
		open && currentOrgId && /* @__PURE__ */ jsx(NewSecretDialog, {
			orgId: currentOrgId,
			onClose: () => setOpen(false)
		}),
		selected && /* @__PURE__ */ jsx(SecretDetail, {
			credential: selected,
			...
			children: [
				/* @__PURE__ */ jsx(Field, {
					...
					children: /* @__PURE__ */ jsxs("select", {
						...
						}), providers.data?.map((provider) => /* @__PURE__ */ jsx("option", {
							value: provider.id,
							children: provider.label
						}, provider.id))]
					})
				...
				/* @__PURE__ */ jsx(Field, {
					...
					children: /* @__PURE__ */ jsxs("select", {
						...
						children: [/* @__PURE__ */ jsx("option", {
							value: "",
							children: "Org-wide"
						}), projects.data?.map((project) => /* @__PURE__ */ jsx("option", {
							value: project.id,
				...
				/* @__PURE__ */ jsx(Field, {
					...
					children: /* @__PURE__ */ jsxs("select", {
						...
						}), projectEnvs.map((env) => /* @__PURE__ */ jsxs("option", {
							value: env.id,
							children: [
								env.name,
								" · ",
	...
	return /* @__PURE__ */ jsx(DialogShell, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							className: "text-muted-foreground",
							children: "Status"
						}), /* @__PURE__ */ jsx(StatusPill, { status: credential.status })] }),
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							className: "text-muted-foreground",
							children: "Created"
						}), /* @__PURE__ */ jsx("div", { children: new Date(credential.created_at).toLocaleString() })] }),
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							className: "text-muted-foreground",
							children: "Last rotated"
						}), /* @__PURE__ */ jsx("div", { children: credential.last_rotated_at ? new Date(credential.last_rotated_at).toLocaleString() : "—" })] })
					]
				}),
				/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("table", {
						...
						children: [/* @__PURE__ */ jsx("thead", {
							...
							children: versions.data?.map((version) => /* @__PURE__ */ jsxs("tr", { children: [
								...
								/* @__PURE__ */ jsx(Td, { children: version.is_active ? /* @__PURE__ */ jsx(StatusPill, {
									status: "active",
									children: "active"
								}) : /* @__PURE__ */ jsx("span", {
									className: "text-mono-xs text-muted-foreground",
				...
				canManage && credential.status !== "deactivated" && /* @__PURE__ */ jsx("div", {
					className: "space-y-3 rounded-lg border border-border p-3",
					children: rotating ? /* @__PURE__ */ jsxs("form", {
						onSubmit: (event) => {
							event.preventDefault();
							doRotate.mutate();
						},
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: [/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(RefreshCcw, { className: "h-3 w-3" }), "Rotate"]
								...
								children: [/* @__PURE__ */ jsx(ShieldOff, { className: "h-3 w-3" }), "Deactivate"]
							})]
						})]
					})
				})
