...
//#region src/components/platform-ui.tsx
...
function StatusDot({ status }) {
	return /* @__PURE__ */ jsx("span", { className: "inline-block h-1.5 w-1.5 rounded-full " + ({
		active: "bg-success",
		paused: "bg-warning",
...
function StatusPill({ status, children }) {
	return /* @__PURE__ */ jsxs("span", {
		...
		children: [/* @__PURE__ */ jsx(StatusDot, { status }), children ?? status.toUpperCase()]
	});
}
