...
import { T as FolderKanban, U as Building2, _ as PlugZap, c as ShieldCheck, d as Server, p as ScrollText, t as Workflow } from "./_libs/lucide-react.mjs";
import { d as useEnvironments, h as useProjects, i as useAuditEvents, p as useMyOrganizations } from "./_ssr/queries-CytnrJBF.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_app.dashboard-DqBsMtzV.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: stats.map((stat) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MetricCard, {
					label: stat.label,
					value: String(stat.value),
					icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(stat.icon, { className: "h-4 w-4" }),
					tone: stat.tone
				}, stat.label))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReadinessRow, {
								label: "Identity",
								status: "Active",
								tone: "good"
							}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						children: "Tenant-scoped audit feed for platform actions."
					})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "text-mono-xs text-muted-foreground",
						children: [recent.length, " EVENTS"]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "divide-y divide-border",
					children: [recent.slice(0, 10).map((event) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}, event.id)), recent.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function MetricCard({ label, value, icon, tone }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: `rounded-lg border p-4 ${tone === "success" ? "border-status-paid/20 bg-status-paid/5" : tone === "warning" ? "border-status-pending/20 bg-status-pending/5" : tone === "primary" ? "border-primary/20 bg-primary/5" : "border-border bg-surface-1"}`,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function ReadinessRow({ label, status, tone }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			className: `font-mono text-xs ${tone === "good" ? "text-status-paid" : tone === "warn" ? "text-status-pending" : "text-muted-foreground"}`,
			children: status
		})]
	});
}
