...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DzLZpsZn.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				className: "relative z-10 mx-auto max-w-4xl px-6 pt-24 pb-32 text-center",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-mono-xs text-muted-foreground",
						children: "PLATFORM // v0.1"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: "for every Valtaris product."
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mx-auto mt-6 max-w-2xl text-base text-muted-foreground",
						children: "Identity, tenancy, audit, telemetry, secrets, connectors, workflows, evidence, decisions, governance. One modular monolith. Built for DualPay, Weaver, Glue, Guardian and what comes next."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-24 grid grid-cols-2 gap-px overflow-hidden rounded-lg border border-border bg-border md:grid-cols-4",
						children: [
							...
							className: "bg-surface-1 p-5 text-left",
