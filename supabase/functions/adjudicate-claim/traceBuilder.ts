 ...
 * src/nucleus/subsystems/guardian/adjudication/traceBuilder.ts (pure,
 * no runtime dependencies beyond ./types).
 *
 * Important:
 * - No Date.now()
 * - No new Date()
...
import type { TraceObject, RuleFiring, RuleCategory, MathStep, SourceBadge } from "./types.ts";
import type { PlanBenefits, ContractTerms } from "./types.ts";
