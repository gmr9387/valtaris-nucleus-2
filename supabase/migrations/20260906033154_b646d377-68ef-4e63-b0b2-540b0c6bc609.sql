...
REVOKE EXECUTE ON FUNCTION public.workflow_version_guard() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.workflow_run_guard() FROM PUBLIC, anon, authenticated;
